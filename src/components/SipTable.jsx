            ...
            {sips.map((sip) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-4">{DISALLOW}</td>
                  <td className="px-4 py-4">{HOST}</td>
                  <td className="px-4 py-4">{ALLOW}</td>
                  <td className="px-4 py-4">{TYPE}</td>
                  <td className="px-4 py-4">{SECRET}</td>
                  <td className="px-4 py-4">{DTMFMODE}</td>
                  <td className="px-4 py-4">{QUALIFY}</td>
                  <td className="px-4 py-4">{CANREINVITE}</td>
                  <td className="px-4 py-4">{INSECURE}</td>
                  <td className="px-4 py-4">{NAT}</td>
                  <td className="px-4 py-4">{DIRECTMEDIA}</td>
                  <td className="px-4 py-4">{DIRECTRTPSETUP}</td>
                  <td className="px-4 py-4">{CONTEXT}</td>
